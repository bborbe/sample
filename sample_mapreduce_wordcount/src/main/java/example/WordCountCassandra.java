...
public class WordCountCassandra extends Configured implements Tool {
	...
	public static final String INPUT_COLUMN_NAME = "text";

	public static final String INPUT_KEYSPACE = "wordcount";

	public static final String INPUT_COLUMN_FAMILY = "input_words";

	public static final String OUTPUT_KEYSPACE = "wordcount";

	public static final String OUTPUT_COLUMN_FAMILY = "output_words";

	public static final String HOSTNAME = "localhost";

	public static final String PORT = "9160";

	public static final String PARTITIONER = "org.apache.cassandra.dht.RandomPartitioner";
	...
	public int run(String[] args) throws Exception {
		...
		ConfigHelper.setInputColumnFamily(job.getConfiguration(), INPUT_KEYSPACE, INPUT_COLUMN_FAMILY);
		ConfigHelper.setInputRpcPort(job.getConfiguration(), PORT);
		ConfigHelper.setInputInitialAddress(job.getConfiguration(), HOSTNAME);
		...
		ConfigHelper.setOutputColumnFamily(job.getConfiguration(), OUTPUT_KEYSPACE, OUTPUT_COLUMN_FAMILY);
		ConfigHelper.setOutputRpcPort(job.getConfiguration(), PORT);
		ConfigHelper.setOutputInitialAddress(job.getConfiguration(), HOSTNAME);
